...
_$_TopicDto _$$_TopicDtoFromJson(Map<String, dynamic> json) => _$_TopicDto(
      ...
      quizzes: (json['quizzes'] as List<dynamic>?)?.map((e) => QuizDto.fromJson(e as Map<String, dynamic>)).toList(),
    );

Map<String, dynamic> _$$_TopicDtoToJson(_$_TopicDto instance) => <String, dynamic>{
      '_id': instance.id,
