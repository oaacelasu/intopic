...
final topQuizzesProvider = AutoDisposeFutureProvider<List<Quiz>>.internal(
  ...
  debugGetCreateSourceHash: const bool.fromEnvironment('dart.vm.product') ? null : _$topQuizzesHash,
  dependencies: null,
...
final topicsProvider = AutoDisposeFutureProvider<List<Topic>>.internal(
  ...
  debugGetCreateSourceHash: const bool.fromEnvironment('dart.vm.product') ? null : _$topicsHash,
  dependencies: null,
  allTransitiveDependencies: null,
);
...
String _$filteredTopQuizzesHash() => r'4d3d37950a3b4f5176aa47104804a8dc85cb0fc3';

/// See also [filteredTopQuizzes].
@ProviderFor(filteredTopQuizzes)
final filteredTopQuizzesProvider = AutoDisposeFutureProvider<List<Quiz>>.internal(
  filteredTopQuizzes,
  name: r'filteredTopQuizzesProvider',
  debugGetCreateSourceHash: const bool.fromEnvironment('dart.vm.product') ? null : _$filteredTopQuizzesHash,
  dependencies: null,
  allTransitiveDependencies: null,
);
...
final filteredTopicsProvider = AutoDisposeFutureProvider<List<Topic>>.internal(
  ...
  debugGetCreateSourceHash: const bool.fromEnvironment('dart.vm.product') ? null : _$filteredTopicsHash,
  dependencies: null,
  allTransitiveDependencies: null,
);
...
final currentTopQuizProvider = AutoDisposeProvider<Quiz>.internal(
  ...
  debugGetCreateSourceHash: const bool.fromEnvironment('dart.vm.product') ? null : _$currentTopQuizHash,
  dependencies: null,
  allTransitiveDependencies: null,
);
...
final homeFilterProvider = AutoDisposeNotifierProvider<HomeFilter, String>.internal(
  HomeFilter.new,
  name: r'homeFilterProvider',
  debugGetCreateSourceHash: const bool.fromEnvironment('dart.vm.product') ? null : _$homeFilterHash,
  dependencies: null,
  allTransitiveDependencies: null,
);
